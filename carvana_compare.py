...
class MyTestCase(unittest.TestCase):
    def test_vehicle(self):
        ...
        uninteresting_features = ['Tire Inflator Kit', 'Engine', 'Power Seat Controls', 'Collision Detection',
        ...
        for vehicleId in vehicle_ids:
            ...
            result[vehicleId]['location'] = f"{data['header']['location']['city']}, {data['header']['location']['stateAbbreviation']}"
            ...
            # print(', '.join(unique_features))
        df = pd.DataFrame.from_dict(result, orient='index')
        print(df)
        df.to_csv('carvana_result.csv')

        # pprint(features)

        # self.assertEqual(data['details']['basics']['vin'], '3FTTW8H94RRA28930')
